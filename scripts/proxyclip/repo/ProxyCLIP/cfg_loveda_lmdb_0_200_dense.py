# cfg_loveda_lmdb_0_200_dense.py
custom_imports = dict(imports=['proxyclip_segmentor_dense'], allow_failed_imports=False)
...
# ====== model ======
model = dict(
    type='ProxyCLIPSegmentationDense',   # ✅ 用新路线的类（不影响旧类）
    clip_type='openai',
    model_type='ViT-B/16',
    vfm_model='dense',                   # ✅ dense: 不用 SAM/SAM3 mask
