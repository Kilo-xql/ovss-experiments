...
model = dict(
    ...
    clip_type='openai',
    model_type='ViT-B/16',
    vfm_model='sam',   # sam, mae, dino, dinov2
    checkpoint=r'/mnt/e/ovss_project/pythonProject1/ovss_experiments_repo/scripts/proxyclip/checkpoints/sam/sam_vit_h_4b8939.pth',
)
# ('openai', 'ViT-B/16')
# ('openai', 'ViT-L-14')
